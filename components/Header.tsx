  ...
  return (
    <header className="bg-zinc-950/70 backdrop-blur-md p-4 sticky top-0 z-30 border-b border-white/5">
      ...
      <div className="lg:hidden flex items-center justify-center gap-4 mt-4 pb-2">
        <button onClick={onPrevMonth} className="p-2 rounded-full hover:bg-zinc-800 transition-colors">
        ...
        <button onClick={onNextMonth} className="p-2 rounded-full hover:bg-zinc-800 transition-colors">
